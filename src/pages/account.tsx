...
function AccountData() {
  ...
  return (
    <div>
      <Navbar />
      <div className="mx-auto pt-4 px-4 sm:px-80 bg-gray-800 min-h-screen text-gray-100">
        <div className="w-full sm:w-1/2 rounded mx-auto">
          ...
          <div className="w-full mt-4 sm:mt-4 flex justify-between px-2 bg-gray-600">
            {results && (
